...
- **hermes-agent**: Hermes Agent 지식 베이스 검색 (`argument-hint: [질문]`)
- **cloudflare-one**: Cloudflare One 지식 베이스 검색 (`argument-hint: [질문]`)
- **langfuse**: Langfuse 지식 베이스 검색 (`argument-hint: [질문]`)
- **k3s**: k3s 지식 베이스 검색 (`argument-hint: [질문]`)
- **kubeflow**: Kubeflow 지식 베이스 검색 (`argument-hint: [질문]`)
...
- **hermes-agent-master**: Hermes Agent 지식 베이스 전문가 (kb CLI 기반 검색)
- **cloudflare-one-master**: Cloudflare One 지식 베이스 전문가 (kb CLI 기반 검색)
- **langfuse-master**: Langfuse 지식 베이스 전문가 (kb CLI 기반 검색)
- **k3s-master**: k3s 지식 베이스 전문가 (kb CLI 기반 검색)
- **kubeflow-master**: Kubeflow 지식 베이스 전문가 (kb CLI 기반 검색)
